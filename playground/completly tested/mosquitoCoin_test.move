...
//         MosquitoCoinTest1::initialize(admin);
//     }
...
//         let coins = MosquitoCoinTest1::mint_farm_SUCKR(resource_account, INIT_FAUCET_COIN);//
...
//         MosquitoCoinTest1::register_SUCKR(admin);//
//         MosquitoCoinTest1::burn_SUCKR(resource_account, 120);
...
//         MosquitoCoinTest1::set_airdrop_address(admin, signer::address_of(airdrop_account));
//         MosquitoCoinTest1::set_marketing_address(admin, signer::address_of(marketing_account));
//         MosquitoCoinTest1::withdraw_SUCKR_for_airdrop(airdrop_account);
//         MosquitoCoinTest1::withdraw_SUCKR_for_marketing(marketing_account);
        
//         MosquitoCoinTest1::lock_SUCKR(airdrop_account, 2666599999989, 50);
//         MosquitoCoinTest1::lock_SUCKR(airdrop_account, 11, 90);
//         MosquitoCoinTest1::lock_SUCKR(marketing_account, 300000000000000, 50);

//         MosquitoCoinTest1::unlock_SUCKR(airdrop_account);
