...
module FACoin::fa_coin3 {
    ...
    public entry fun claim(user: &signer, amount: u64) acquires ManagedFungibleAsset {
        ...
        let from_wallet = primary_fungible_store::primary_store(@FACoin, asset);
    ...
    inline fun authorized_borrow_refs(
     ...
     inline fun authorized_borrow_refs_without_owner(
        ...
        assert!(object::is_owner(asset, @FACoin), error::permission_denied(ENOT_OWNER));
        borrow_global<ManagedFungibleAsset>(object::object_address(&asset))
    }
